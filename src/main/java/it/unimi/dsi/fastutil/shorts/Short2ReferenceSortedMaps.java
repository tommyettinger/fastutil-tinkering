...
public class Short2ReferenceSortedMaps {
	...
	public static class Singleton <V> extends Short2ReferenceMaps.Singleton <V> implements Short2ReferenceSortedMap <V>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Short2ReferenceMap.Entry <V> > short2ReferenceEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Short2ReferenceMap.Entry <V>)new AbstractShort2ReferenceMap.BasicEntry <V>(key, value), (Comparator<? super Short2ReferenceMap.Entry <V> >)entryComparator(comparator)); return (ObjectSortedSet<Short2ReferenceMap.Entry <V> >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
