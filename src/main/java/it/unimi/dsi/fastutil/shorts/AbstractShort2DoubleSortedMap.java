...
public abstract class AbstractShort2DoubleSortedMap extends AbstractShort2DoubleMap implements Short2DoubleSortedMap {
	...
	protected class KeySet extends AbstractShortSortedSet {
	 ...
	 @Override
	 public ShortBidirectionalIterator iterator() { return new KeySetIterator (short2DoubleEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractDoubleCollection {
	 @Override
	 public DoubleIterator iterator() { return new ValuesIterator (short2DoubleEntrySet().iterator()); }
	 @Override
