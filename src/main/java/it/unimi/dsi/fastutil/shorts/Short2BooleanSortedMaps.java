...
public class Short2BooleanSortedMaps {
	...
	public static class Singleton extends Short2BooleanMaps.Singleton implements Short2BooleanSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Short2BooleanMap.Entry > short2BooleanEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Short2BooleanMap.Entry )new AbstractShort2BooleanMap.BasicEntry (key, value), (Comparator<? super Short2BooleanMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Short2BooleanMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
