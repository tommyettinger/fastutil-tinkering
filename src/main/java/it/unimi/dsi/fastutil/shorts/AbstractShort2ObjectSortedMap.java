...
public abstract class AbstractShort2ObjectSortedMap <V> extends AbstractShort2ObjectMap <V> implements Short2ObjectSortedMap <V> {
	...
	protected class KeySet extends AbstractShortSortedSet {
	 ...
	 @Override
	 public ShortBidirectionalIterator iterator(final short from) { return new KeySetIterator <V>(short2ObjectEntrySet().iterator(new BasicEntry <V>(from, (null)))); }
	 @Override
	 public ShortBidirectionalIterator iterator() { return new KeySetIterator <V>(short2ObjectEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractObjectCollection <V> {
	 @Override
	 public ObjectIterator <V> iterator() { return new ValuesIterator <V>(short2ObjectEntrySet().iterator()); }
	 @Override
