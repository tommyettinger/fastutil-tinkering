...
public class Short2LongSortedMaps {
	...
	public static class Singleton extends Short2LongMaps.Singleton implements Short2LongSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Short2LongMap.Entry > short2LongEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Short2LongMap.Entry )new AbstractShort2LongMap.BasicEntry (key, value), (Comparator<? super Short2LongMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Short2LongMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
