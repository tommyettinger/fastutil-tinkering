...
public class Short2ObjectArrayMap <V> extends AbstractShort2ObjectMap <V> implements java.io.Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<Short2ObjectMap.Entry <V> > implements FastEntrySet <V> {
	 ...
	 public ObjectIterator<Short2ObjectMap.Entry <V> > iterator() {
	  return new AbstractObjectIterator<Short2ObjectMap.Entry <V> >() {
	   ...
	   public Entry <V> next() {
	    ...
	    return new AbstractShort2ObjectMap.BasicEntry <V>( key[curr = next], (V) value[next++]);
	   }
	   @Override
	   public void remove() {
	 ...
	 public boolean remove(final Object o) {
	  ...
	  if (oldPos == -1 || ! ( (v) == null ? (Short2ObjectArrayMap.this.value[oldPos]) == null : (v).equals(Short2ObjectArrayMap.this.value[oldPos]) )) return false;
