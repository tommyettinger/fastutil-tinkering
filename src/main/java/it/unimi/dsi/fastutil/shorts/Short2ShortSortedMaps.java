...
public class Short2ShortSortedMaps {
	...
	public static class Singleton extends Short2ShortMaps.Singleton implements Short2ShortSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Short2ShortMap.Entry > short2ShortEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Short2ShortMap.Entry )new AbstractShort2ShortMap.BasicEntry (key, value), (Comparator<? super Short2ShortMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Short2ShortMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
