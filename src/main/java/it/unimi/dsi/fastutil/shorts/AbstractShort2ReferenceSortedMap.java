...
public abstract class AbstractShort2ReferenceSortedMap <V> extends AbstractShort2ReferenceMap <V> implements Short2ReferenceSortedMap <V> {
	...
	protected class KeySet extends AbstractShortSortedSet {
	 ...
	 @Override
	 public ShortBidirectionalIterator iterator(final short from) { return new KeySetIterator <V>(short2ReferenceEntrySet().iterator(new BasicEntry <V>(from, (null)))); }
	 @Override
	 public ShortBidirectionalIterator iterator() { return new KeySetIterator <V>(short2ReferenceEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractReferenceCollection <V> {
	 @Override
	 public ObjectIterator <V> iterator() { return new ValuesIterator <V>(short2ReferenceEntrySet().iterator()); }
	 @Override
