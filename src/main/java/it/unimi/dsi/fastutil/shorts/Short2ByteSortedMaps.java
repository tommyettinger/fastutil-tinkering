...
public class Short2ByteSortedMaps {
	...
	public static class Singleton extends Short2ByteMaps.Singleton implements Short2ByteSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Short2ByteMap.Entry > short2ByteEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Short2ByteMap.Entry )new AbstractShort2ByteMap.BasicEntry (key, value), (Comparator<? super Short2ByteMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Short2ByteMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
