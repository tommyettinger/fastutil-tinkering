...
public abstract class AbstractShortList extends AbstractShortCollection implements ShortList , ShortStack {
	...
	/** {@inheritDoc}
	 *
	 * <p>This implementation delegates to the new covariantly stronger generic method  {@link #listIterator()}.
	...
	/** {@inheritDoc}
	 *
	 * <p>This implementation delegates to the new covariantly stronger generic method {@link #listIterator(int)}.
	 * @deprecated As of <code>fastutil</code> 5, replaced by {@link #listIterator()}.
	 */
	@Deprecated
	@Override
	...
	/** {@inheritDoc}
	 *
	 * <p>This implementation delegates to the new covariantly stronger generic method  {@link #subList(int, int)}.
