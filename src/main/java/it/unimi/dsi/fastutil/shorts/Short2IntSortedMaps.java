...
public class Short2IntSortedMaps {
	...
	public static class Singleton extends Short2IntMaps.Singleton implements Short2IntSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Short2IntMap.Entry > short2IntEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Short2IntMap.Entry )new AbstractShort2IntMap.BasicEntry (key, value), (Comparator<? super Short2IntMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Short2IntMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
