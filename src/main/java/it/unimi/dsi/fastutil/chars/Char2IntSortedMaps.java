...
public class Char2IntSortedMaps {
	...
	public static class Singleton extends Char2IntMaps.Singleton implements Char2IntSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Char2IntMap.Entry > char2IntEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Char2IntMap.Entry )new AbstractChar2IntMap.BasicEntry (key, value), (Comparator<? super Char2IntMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Char2IntMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
