...
public class Char2IntMaps {
	...
	public static class Singleton extends Char2IntFunctions.Singleton implements Char2IntMap , java.io.Serializable, Cloneable {
	 ...
	 public void putAll(final Map<? extends Character, ? extends Integer> m) { throw new UnsupportedOperationException(); }
	 @Override
	 public ObjectSet<Char2IntMap.Entry > char2IntEntrySet() { if (entries == null) entries = ObjectSets.singleton((Char2IntMap.Entry )new AbstractChar2IntMap.BasicEntry (key, value)); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	...
	public static class SynchronizedMap extends Char2IntFunctions.SynchronizedFunction implements Char2IntMap , java.io.Serializable {
	 ...
	 public ObjectSet<Char2IntMap.Entry > char2IntEntrySet() {
	  synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.char2IntEntrySet(), sync); return entries; }
	 }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
