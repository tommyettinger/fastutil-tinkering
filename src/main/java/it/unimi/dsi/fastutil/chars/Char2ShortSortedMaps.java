...
public class Char2ShortSortedMaps {
	...
	public static class Singleton extends Char2ShortMaps.Singleton implements Char2ShortSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Char2ShortMap.Entry > char2ShortEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Char2ShortMap.Entry )new AbstractChar2ShortMap.BasicEntry (key, value), (Comparator<? super Char2ShortMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Char2ShortMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
