...
public class Char2LongSortedMaps {
	...
	public static class Singleton extends Char2LongMaps.Singleton implements Char2LongSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Char2LongMap.Entry > char2LongEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Char2LongMap.Entry )new AbstractChar2LongMap.BasicEntry (key, value), (Comparator<? super Char2LongMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Char2LongMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
