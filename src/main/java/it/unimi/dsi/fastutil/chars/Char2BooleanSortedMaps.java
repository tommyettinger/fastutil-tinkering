...
public class Char2BooleanSortedMaps {
	...
	public static class Singleton extends Char2BooleanMaps.Singleton implements Char2BooleanSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Char2BooleanMap.Entry > char2BooleanEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Char2BooleanMap.Entry )new AbstractChar2BooleanMap.BasicEntry (key, value), (Comparator<? super Char2BooleanMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Char2BooleanMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
