...
public class Char2CharSortedMaps {
	...
	public static class Singleton extends Char2CharMaps.Singleton implements Char2CharSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Char2CharMap.Entry > char2CharEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Char2CharMap.Entry )new AbstractChar2CharMap.BasicEntry (key, value), (Comparator<? super Char2CharMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Char2CharMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
