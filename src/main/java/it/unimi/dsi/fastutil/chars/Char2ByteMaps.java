...
public class Char2ByteMaps {
	...
	public static class Singleton extends Char2ByteFunctions.Singleton implements Char2ByteMap , java.io.Serializable, Cloneable {
	 ...
	 public void putAll(final Map<? extends Character, ? extends Byte> m) { throw new UnsupportedOperationException(); }
	 @Override
	 public ObjectSet<Char2ByteMap.Entry > char2ByteEntrySet() { if (entries == null) entries = ObjectSets.singleton((Char2ByteMap.Entry )new AbstractChar2ByteMap.BasicEntry (key, value)); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	...
	public static class SynchronizedMap extends Char2ByteFunctions.SynchronizedFunction implements Char2ByteMap , java.io.Serializable {
	 ...
	 public ObjectSet<Char2ByteMap.Entry > char2ByteEntrySet() {
	  synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.char2ByteEntrySet(), sync); return entries; }
	 }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
