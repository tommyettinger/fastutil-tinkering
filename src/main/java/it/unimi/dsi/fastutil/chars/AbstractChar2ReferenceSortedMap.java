...
public abstract class AbstractChar2ReferenceSortedMap <V> extends AbstractChar2ReferenceMap <V> implements Char2ReferenceSortedMap <V> {
	...
	protected class KeySet extends AbstractCharSortedSet {
	 ...
	 @Override
	 public CharBidirectionalIterator iterator(final char from) { return new KeySetIterator <V>(char2ReferenceEntrySet().iterator(new BasicEntry <V>(from, (null)))); }
	 @Override
	 public CharBidirectionalIterator iterator() { return new KeySetIterator <V>(char2ReferenceEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractReferenceCollection <V> {
	 @Override
	 public ObjectIterator <V> iterator() { return new ValuesIterator <V>(char2ReferenceEntrySet().iterator()); }
	 @Override
