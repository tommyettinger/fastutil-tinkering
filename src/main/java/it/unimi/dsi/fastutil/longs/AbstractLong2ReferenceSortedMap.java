...
public abstract class AbstractLong2ReferenceSortedMap <V> extends AbstractLong2ReferenceMap <V> implements Long2ReferenceSortedMap <V> {
	...
	protected class KeySet extends AbstractLongSortedSet {
	 ...
	 @Override
	 public LongBidirectionalIterator iterator(final long from) { return new KeySetIterator <V>(long2ReferenceEntrySet().iterator(new BasicEntry <V>(from, (null)))); }
	 @Override
	 public LongBidirectionalIterator iterator() { return new KeySetIterator <V>(long2ReferenceEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractReferenceCollection <V> {
	 @Override
	 public ObjectIterator <V> iterator() { return new ValuesIterator <V>(long2ReferenceEntrySet().iterator()); }
	 @Override
