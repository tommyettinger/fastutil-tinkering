...
public class Long2ReferenceSortedMaps {
	...
	public static class Singleton <V> extends Long2ReferenceMaps.Singleton <V> implements Long2ReferenceSortedMap <V>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Long2ReferenceMap.Entry <V> > long2ReferenceEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Long2ReferenceMap.Entry <V>)new AbstractLong2ReferenceMap.BasicEntry <V>(key, value), (Comparator<? super Long2ReferenceMap.Entry <V> >)entryComparator(comparator)); return (ObjectSortedSet<Long2ReferenceMap.Entry <V> >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
