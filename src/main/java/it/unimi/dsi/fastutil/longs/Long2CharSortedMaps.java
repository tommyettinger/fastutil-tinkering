...
public class Long2CharSortedMaps {
	...
	public static class Singleton extends Long2CharMaps.Singleton implements Long2CharSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Long2CharMap.Entry > long2CharEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Long2CharMap.Entry )new AbstractLong2CharMap.BasicEntry (key, value), (Comparator<? super Long2CharMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Long2CharMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
