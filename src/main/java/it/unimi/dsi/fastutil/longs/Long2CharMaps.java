...
public class Long2CharMaps {
	...
	public static class Singleton extends Long2CharFunctions.Singleton implements Long2CharMap , java.io.Serializable, Cloneable {
	 ...
	 public void putAll(final Map<? extends Long, ? extends Character> m) { throw new UnsupportedOperationException(); }
	 @Override
	 public ObjectSet<Long2CharMap.Entry > long2CharEntrySet() { if (entries == null) entries = ObjectSets.singleton((Long2CharMap.Entry )new AbstractLong2CharMap.BasicEntry (key, value)); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	...
	public static class SynchronizedMap extends Long2CharFunctions.SynchronizedFunction implements Long2CharMap , java.io.Serializable {
	 ...
	 public ObjectSet<Long2CharMap.Entry > long2CharEntrySet() {
	  synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.long2CharEntrySet(), sync); return entries; }
	 }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
