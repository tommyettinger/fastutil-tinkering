...
public class Long2IntSortedMaps {
	...
	public static class Singleton extends Long2IntMaps.Singleton implements Long2IntSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Long2IntMap.Entry > long2IntEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Long2IntMap.Entry )new AbstractLong2IntMap.BasicEntry (key, value), (Comparator<? super Long2IntMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Long2IntMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
