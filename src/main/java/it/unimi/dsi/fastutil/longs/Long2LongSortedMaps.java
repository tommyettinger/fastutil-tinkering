...
public class Long2LongSortedMaps {
	...
	public static class Singleton extends Long2LongMaps.Singleton implements Long2LongSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Long2LongMap.Entry > long2LongEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Long2LongMap.Entry )new AbstractLong2LongMap.BasicEntry (key, value), (Comparator<? super Long2LongMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Long2LongMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
