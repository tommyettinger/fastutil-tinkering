...
public class Long2ObjectSortedMaps {
	...
	public static class Singleton <V> extends Long2ObjectMaps.Singleton <V> implements Long2ObjectSortedMap <V>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Long2ObjectMap.Entry <V> > long2ObjectEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Long2ObjectMap.Entry <V>)new AbstractLong2ObjectMap.BasicEntry <V>(key, value), (Comparator<? super Long2ObjectMap.Entry <V> >)entryComparator(comparator)); return (ObjectSortedSet<Long2ObjectMap.Entry <V> >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
