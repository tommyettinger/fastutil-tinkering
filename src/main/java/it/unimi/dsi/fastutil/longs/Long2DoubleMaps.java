...
public class Long2DoubleMaps {
	...
	public static class Singleton extends Long2DoubleFunctions.Singleton implements Long2DoubleMap , java.io.Serializable, Cloneable {
	 ...
	 public void putAll(final Map<? extends Long, ? extends Double> m) { throw new UnsupportedOperationException(); }
	 @Override
	 public ObjectSet<Long2DoubleMap.Entry > long2DoubleEntrySet() { if (entries == null) entries = ObjectSets.singleton((Long2DoubleMap.Entry )new AbstractLong2DoubleMap.BasicEntry (key, value)); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	...
	public static class SynchronizedMap extends Long2DoubleFunctions.SynchronizedFunction implements Long2DoubleMap , java.io.Serializable {
	 ...
	 public ObjectSet<Long2DoubleMap.Entry > long2DoubleEntrySet() {
	  synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.long2DoubleEntrySet(), sync); return entries; }
	 }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
