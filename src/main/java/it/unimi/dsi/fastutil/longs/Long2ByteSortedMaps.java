...
public class Long2ByteSortedMaps {
	...
	public static class Singleton extends Long2ByteMaps.Singleton implements Long2ByteSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Long2ByteMap.Entry > long2ByteEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Long2ByteMap.Entry )new AbstractLong2ByteMap.BasicEntry (key, value), (Comparator<? super Long2ByteMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Long2ByteMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
