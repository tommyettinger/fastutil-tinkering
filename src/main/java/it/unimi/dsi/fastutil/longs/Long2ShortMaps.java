...
public class Long2ShortMaps {
	...
	public static class Singleton extends Long2ShortFunctions.Singleton implements Long2ShortMap , java.io.Serializable, Cloneable {
	 ...
	 public void putAll(final Map<? extends Long, ? extends Short> m) { throw new UnsupportedOperationException(); }
	 @Override
	 public ObjectSet<Long2ShortMap.Entry > long2ShortEntrySet() { if (entries == null) entries = ObjectSets.singleton((Long2ShortMap.Entry )new AbstractLong2ShortMap.BasicEntry (key, value)); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	...
	public static class SynchronizedMap extends Long2ShortFunctions.SynchronizedFunction implements Long2ShortMap , java.io.Serializable {
	 ...
	 public ObjectSet<Long2ShortMap.Entry > long2ShortEntrySet() {
	  synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.long2ShortEntrySet(), sync); return entries; }
	 }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
