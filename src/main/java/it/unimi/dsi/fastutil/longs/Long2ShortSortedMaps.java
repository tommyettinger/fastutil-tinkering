...
public class Long2ShortSortedMaps {
	...
	public static class Singleton extends Long2ShortMaps.Singleton implements Long2ShortSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Long2ShortMap.Entry > long2ShortEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Long2ShortMap.Entry )new AbstractLong2ShortMap.BasicEntry (key, value), (Comparator<? super Long2ShortMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Long2ShortMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
