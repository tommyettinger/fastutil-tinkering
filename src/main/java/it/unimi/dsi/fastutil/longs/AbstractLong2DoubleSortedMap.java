...
public abstract class AbstractLong2DoubleSortedMap extends AbstractLong2DoubleMap implements Long2DoubleSortedMap {
	...
	protected class KeySet extends AbstractLongSortedSet {
	 ...
	 @Override
	 public LongBidirectionalIterator iterator() { return new KeySetIterator (long2DoubleEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractDoubleCollection {
	 @Override
	 public DoubleIterator iterator() { return new ValuesIterator (long2DoubleEntrySet().iterator()); }
	 @Override
