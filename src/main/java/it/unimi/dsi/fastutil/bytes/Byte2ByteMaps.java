...
public class Byte2ByteMaps {
	...
	public static class Singleton extends Byte2ByteFunctions.Singleton implements Byte2ByteMap , java.io.Serializable, Cloneable {
	 ...
	 public void putAll(final Map<? extends Byte, ? extends Byte> m) { throw new UnsupportedOperationException(); }
	 @Override
	 public ObjectSet<Byte2ByteMap.Entry > byte2ByteEntrySet() { if (entries == null) entries = ObjectSets.singleton((Byte2ByteMap.Entry )new AbstractByte2ByteMap.BasicEntry (key, value)); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	...
	public static class SynchronizedMap extends Byte2ByteFunctions.SynchronizedFunction implements Byte2ByteMap , java.io.Serializable {
	 ...
	 public ObjectSet<Byte2ByteMap.Entry > byte2ByteEntrySet() {
	  synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.byte2ByteEntrySet(), sync); return entries; }
	 }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
