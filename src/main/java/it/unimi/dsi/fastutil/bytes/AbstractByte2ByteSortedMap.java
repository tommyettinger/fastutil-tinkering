...
public abstract class AbstractByte2ByteSortedMap extends AbstractByte2ByteMap implements Byte2ByteSortedMap {
	...
	protected class KeySet extends AbstractByteSortedSet {
	 ...
	 @Override
	 public ByteBidirectionalIterator iterator() { return new KeySetIterator (byte2ByteEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractByteCollection {
	 @Override
	 public ByteIterator iterator() { return new ValuesIterator (byte2ByteEntrySet().iterator()); }
	 @Override
