...
public class Byte2FloatSortedMaps {
	...
	public static class Singleton extends Byte2FloatMaps.Singleton implements Byte2FloatSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Byte2FloatMap.Entry > byte2FloatEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Byte2FloatMap.Entry )new AbstractByte2FloatMap.BasicEntry (key, value), (Comparator<? super Byte2FloatMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Byte2FloatMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
