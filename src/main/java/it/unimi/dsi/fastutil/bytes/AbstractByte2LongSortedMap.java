...
public abstract class AbstractByte2LongSortedMap extends AbstractByte2LongMap implements Byte2LongSortedMap {
	...
	protected class KeySet extends AbstractByteSortedSet {
	 ...
	 @Override
	 public ByteBidirectionalIterator iterator() { return new KeySetIterator (byte2LongEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractLongCollection {
	 @Override
	 public LongIterator iterator() { return new ValuesIterator (byte2LongEntrySet().iterator()); }
	 @Override
