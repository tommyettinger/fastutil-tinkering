...
public class Byte2BooleanSortedMaps {
	...
	public static class Singleton extends Byte2BooleanMaps.Singleton implements Byte2BooleanSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Byte2BooleanMap.Entry > byte2BooleanEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Byte2BooleanMap.Entry )new AbstractByte2BooleanMap.BasicEntry (key, value), (Comparator<? super Byte2BooleanMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Byte2BooleanMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
