...
public abstract class AbstractByte2ObjectSortedMap <V> extends AbstractByte2ObjectMap <V> implements Byte2ObjectSortedMap <V> {
	...
	protected class KeySet extends AbstractByteSortedSet {
	 ...
	 @Override
	 public ByteBidirectionalIterator iterator(final byte from) { return new KeySetIterator <V>(byte2ObjectEntrySet().iterator(new BasicEntry <V>(from, (null)))); }
	 @Override
	 public ByteBidirectionalIterator iterator() { return new KeySetIterator <V>(byte2ObjectEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractObjectCollection <V> {
	 @Override
	 public ObjectIterator <V> iterator() { return new ValuesIterator <V>(byte2ObjectEntrySet().iterator()); }
	 @Override
