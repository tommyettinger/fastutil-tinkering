...
public class Byte2ObjectSortedMaps {
	...
	public static class Singleton <V> extends Byte2ObjectMaps.Singleton <V> implements Byte2ObjectSortedMap <V>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Byte2ObjectMap.Entry <V> > byte2ObjectEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Byte2ObjectMap.Entry <V>)new AbstractByte2ObjectMap.BasicEntry <V>(key, value), (Comparator<? super Byte2ObjectMap.Entry <V> >)entryComparator(comparator)); return (ObjectSortedSet<Byte2ObjectMap.Entry <V> >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
