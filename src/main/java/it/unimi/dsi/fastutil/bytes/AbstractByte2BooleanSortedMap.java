...
public abstract class AbstractByte2BooleanSortedMap extends AbstractByte2BooleanMap implements Byte2BooleanSortedMap {
	...
	protected class KeySet extends AbstractByteSortedSet {
	 ...
	 @Override
	 public ByteBidirectionalIterator iterator() { return new KeySetIterator (byte2BooleanEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractBooleanCollection {
	 @Override
	 public BooleanIterator iterator() { return new ValuesIterator (byte2BooleanEntrySet().iterator()); }
	 @Override
