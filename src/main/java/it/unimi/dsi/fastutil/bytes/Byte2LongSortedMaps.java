...
public class Byte2LongSortedMaps {
	...
	public static class Singleton extends Byte2LongMaps.Singleton implements Byte2LongSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Byte2LongMap.Entry > byte2LongEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Byte2LongMap.Entry )new AbstractByte2LongMap.BasicEntry (key, value), (Comparator<? super Byte2LongMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Byte2LongMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
