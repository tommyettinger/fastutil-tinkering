...
public class Byte2DoubleSortedMaps {
	...
	public static class Singleton extends Byte2DoubleMaps.Singleton implements Byte2DoubleSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Byte2DoubleMap.Entry > byte2DoubleEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Byte2DoubleMap.Entry )new AbstractByte2DoubleMap.BasicEntry (key, value), (Comparator<? super Byte2DoubleMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Byte2DoubleMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
