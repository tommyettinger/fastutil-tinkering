...
public class Byte2ObjectArrayMap <V> extends AbstractByte2ObjectMap <V> implements java.io.Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<Byte2ObjectMap.Entry <V> > implements FastEntrySet <V> {
	 ...
	 public ObjectIterator<Byte2ObjectMap.Entry <V> > iterator() {
	  return new AbstractObjectIterator<Byte2ObjectMap.Entry <V> >() {
	   ...
	   public Entry <V> next() {
	    ...
	    return new AbstractByte2ObjectMap.BasicEntry <V>( key[curr = next], (V) value[next++]);
	   }
	   @Override
	   public void remove() {
	 ...
	 public boolean remove(final Object o) {
	  ...
	  if (oldPos == -1 || ! ( (v) == null ? (Byte2ObjectArrayMap.this.value[oldPos]) == null : (v).equals(Byte2ObjectArrayMap.this.value[oldPos]) )) return false;
