...
public class Byte2IntMaps {
	...
	public static class Singleton extends Byte2IntFunctions.Singleton implements Byte2IntMap , java.io.Serializable, Cloneable {
	 ...
	 public void putAll(final Map<? extends Byte, ? extends Integer> m) { throw new UnsupportedOperationException(); }
	 @Override
	 public ObjectSet<Byte2IntMap.Entry > byte2IntEntrySet() { if (entries == null) entries = ObjectSets.singleton((Byte2IntMap.Entry )new AbstractByte2IntMap.BasicEntry (key, value)); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	...
	public static class SynchronizedMap extends Byte2IntFunctions.SynchronizedFunction implements Byte2IntMap , java.io.Serializable {
	 ...
	 public ObjectSet<Byte2IntMap.Entry > byte2IntEntrySet() {
	  synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.byte2IntEntrySet(), sync); return entries; }
	 }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
