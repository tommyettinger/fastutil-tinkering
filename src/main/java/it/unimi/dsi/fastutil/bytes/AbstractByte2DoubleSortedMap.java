...
public abstract class AbstractByte2DoubleSortedMap extends AbstractByte2DoubleMap implements Byte2DoubleSortedMap {
	...
	protected class KeySet extends AbstractByteSortedSet {
	 ...
	 @Override
	 public ByteBidirectionalIterator iterator() { return new KeySetIterator (byte2DoubleEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractDoubleCollection {
	 @Override
	 public DoubleIterator iterator() { return new ValuesIterator (byte2DoubleEntrySet().iterator()); }
	 @Override
