...
public class Byte2CharMaps {
	...
	public static class Singleton extends Byte2CharFunctions.Singleton implements Byte2CharMap , java.io.Serializable, Cloneable {
	 ...
	 public void putAll(final Map<? extends Byte, ? extends Character> m) { throw new UnsupportedOperationException(); }
	 @Override
	 public ObjectSet<Byte2CharMap.Entry > byte2CharEntrySet() { if (entries == null) entries = ObjectSets.singleton((Byte2CharMap.Entry )new AbstractByte2CharMap.BasicEntry (key, value)); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	...
	public static class SynchronizedMap extends Byte2CharFunctions.SynchronizedFunction implements Byte2CharMap , java.io.Serializable {
	 ...
	 public ObjectSet<Byte2CharMap.Entry > byte2CharEntrySet() {
	  synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.byte2CharEntrySet(), sync); return entries; }
	 }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
