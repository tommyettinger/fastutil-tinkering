...
public class Byte2ShortSortedMaps {
	...
	public static class Singleton extends Byte2ShortMaps.Singleton implements Byte2ShortSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Byte2ShortMap.Entry > byte2ShortEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Byte2ShortMap.Entry )new AbstractByte2ShortMap.BasicEntry (key, value), (Comparator<? super Byte2ShortMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Byte2ShortMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
