...
public class Byte2IntSortedMaps {
	...
	public static class Singleton extends Byte2IntMaps.Singleton implements Byte2IntSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Byte2IntMap.Entry > byte2IntEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Byte2IntMap.Entry )new AbstractByte2IntMap.BasicEntry (key, value), (Comparator<? super Byte2IntMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Byte2IntMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
