...
public class Object2ReferenceSortedMaps {
	...
	public static class Singleton <K,V> extends Object2ReferenceMaps.Singleton <K,V> implements Object2ReferenceSortedMap <K,V>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSortedSet<Object2ReferenceMap.Entry <K,V> > object2ReferenceEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Object2ReferenceMap.Entry <K,V>)new AbstractObject2ReferenceMap.BasicEntry <K,V>(key, value), (Comparator<? super Object2ReferenceMap.Entry <K,V> >)entryComparator(comparator)); return (ObjectSortedSet<Object2ReferenceMap.Entry <K,V> >)entries; }
	 /** {@inheritDoc} */
	 @Override
