...
public class Reference2ByteSortedMaps {
	...
	public static class Singleton <K> extends Reference2ByteMaps.Singleton <K> implements Reference2ByteSortedMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSortedSet<Reference2ByteMap.Entry <K> > reference2ByteEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Reference2ByteMap.Entry <K>)new AbstractReference2ByteMap.BasicEntry <K>(key, value), (Comparator<? super Reference2ByteMap.Entry <K> >)entryComparator(comparator)); return (ObjectSortedSet<Reference2ByteMap.Entry <K> >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
