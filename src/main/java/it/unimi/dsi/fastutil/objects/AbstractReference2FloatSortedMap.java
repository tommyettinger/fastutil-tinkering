...
public abstract class AbstractReference2FloatSortedMap <K> extends AbstractReference2FloatMap <K> implements Reference2FloatSortedMap <K> {
	...
	protected class KeySet extends AbstractReferenceSortedSet <K> {
	 ...
	 @Override
	 public ObjectBidirectionalIterator <K> iterator(final K from) { return new KeySetIterator <K>(reference2FloatEntrySet().iterator(new BasicEntry <K>(from, (0)))); }
	 @Override
	 public ObjectBidirectionalIterator <K> iterator() { return new KeySetIterator <K>(reference2FloatEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractFloatCollection {
	 @Override
	 public FloatIterator iterator() { return new ValuesIterator <K>(reference2FloatEntrySet().iterator()); }
	 @Override
