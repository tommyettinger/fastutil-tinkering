...
public class Object2ObjectArrayMap <K,V> extends AbstractObject2ObjectMap <K,V> implements java.io.Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<Object2ObjectMap.Entry <K,V> > implements FastEntrySet <K,V> {
	 ...
	 public ObjectIterator<Object2ObjectMap.Entry <K,V> > iterator() {
	  return new AbstractObjectIterator<Object2ObjectMap.Entry <K,V> >() {
	   ...
	   public Entry <K,V> next() {
	    ...
	    return new AbstractObject2ObjectMap.BasicEntry <K,V>((K) key[curr = next], (V) value[next++]);
	   }
	   @Override
	   public void remove() {
	 ...
	 public boolean remove(final Object o) {
	  ...
	  if (oldPos == -1 || ! ( (v) == null ? (Object2ObjectArrayMap.this.value[oldPos]) == null : (v).equals(Object2ObjectArrayMap.this.value[oldPos]) )) return false;
