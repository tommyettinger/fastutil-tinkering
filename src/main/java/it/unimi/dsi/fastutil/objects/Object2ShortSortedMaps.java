...
public class Object2ShortSortedMaps {
	...
	public static class Singleton <K> extends Object2ShortMaps.Singleton <K> implements Object2ShortSortedMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSortedSet<Object2ShortMap.Entry <K> > object2ShortEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Object2ShortMap.Entry <K>)new AbstractObject2ShortMap.BasicEntry <K>(key, value), (Comparator<? super Object2ShortMap.Entry <K> >)entryComparator(comparator)); return (ObjectSortedSet<Object2ShortMap.Entry <K> >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
