...
public class Reference2ReferenceMaps {
	...
	public static class Singleton <K,V> extends Reference2ReferenceFunctions.Singleton <K,V> implements Reference2ReferenceMap <K,V>, java.io.Serializable, Cloneable {
	 ...
	 public void putAll(final Map<? extends K, ? extends V> m) { throw new UnsupportedOperationException(); }
	 @Override
	 public ObjectSet<Reference2ReferenceMap.Entry <K,V> > reference2ReferenceEntrySet() { if (entries == null) entries = ObjectSets.singleton((Reference2ReferenceMap.Entry <K,V>)new AbstractReference2ReferenceMap.BasicEntry <K,V>(key, value)); return entries; }
	 /** {@inheritDoc} */
	 @Override
	 @SuppressWarnings({ "rawtypes", "unchecked" })
	 public ObjectSet<Map.Entry<K, V>> entrySet() { return (ObjectSet)reference2ReferenceEntrySet(); }
	...
	public static class SynchronizedMap <K,V> extends Reference2ReferenceFunctions.SynchronizedFunction <K,V> implements Reference2ReferenceMap <K,V>, java.io.Serializable {
	 ...
	 public ObjectSet<Reference2ReferenceMap.Entry <K,V> > reference2ReferenceEntrySet() {
	  synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.reference2ReferenceEntrySet(), sync); return entries; }
	 }
	 /** {@inheritDoc} */
	 @Override
