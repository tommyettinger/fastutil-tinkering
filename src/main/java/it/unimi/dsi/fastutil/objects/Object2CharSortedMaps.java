...
public class Object2CharSortedMaps {
	...
	public static class Singleton <K> extends Object2CharMaps.Singleton <K> implements Object2CharSortedMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSortedSet<Object2CharMap.Entry <K> > object2CharEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Object2CharMap.Entry <K>)new AbstractObject2CharMap.BasicEntry <K>(key, value), (Comparator<? super Object2CharMap.Entry <K> >)entryComparator(comparator)); return (ObjectSortedSet<Object2CharMap.Entry <K> >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
