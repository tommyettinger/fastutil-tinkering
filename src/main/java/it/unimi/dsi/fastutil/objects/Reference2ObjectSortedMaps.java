...
public class Reference2ObjectSortedMaps {
	...
	public static class Singleton <K,V> extends Reference2ObjectMaps.Singleton <K,V> implements Reference2ObjectSortedMap <K,V>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSortedSet<Reference2ObjectMap.Entry <K,V> > reference2ObjectEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Reference2ObjectMap.Entry <K,V>)new AbstractReference2ObjectMap.BasicEntry <K,V>(key, value), (Comparator<? super Reference2ObjectMap.Entry <K,V> >)entryComparator(comparator)); return (ObjectSortedSet<Reference2ObjectMap.Entry <K,V> >)entries; }
	 /** {@inheritDoc} */
	 @Override
