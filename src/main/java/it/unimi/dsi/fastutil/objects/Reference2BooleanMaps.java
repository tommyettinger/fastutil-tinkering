...
public class Reference2BooleanMaps {
	...
	public static class Singleton <K> extends Reference2BooleanFunctions.Singleton <K> implements Reference2BooleanMap <K>, java.io.Serializable, Cloneable {
	 ...
	 public void putAll(final Map<? extends K, ? extends Boolean> m) { throw new UnsupportedOperationException(); }
	 @Override
	 public ObjectSet<Reference2BooleanMap.Entry <K> > reference2BooleanEntrySet() { if (entries == null) entries = ObjectSets.singleton((Reference2BooleanMap.Entry <K>)new AbstractReference2BooleanMap.BasicEntry <K>(key, value)); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
