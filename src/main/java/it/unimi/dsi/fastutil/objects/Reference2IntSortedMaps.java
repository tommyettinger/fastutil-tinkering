...
public class Reference2IntSortedMaps {
	...
	public static class Singleton <K> extends Reference2IntMaps.Singleton <K> implements Reference2IntSortedMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSortedSet<Reference2IntMap.Entry <K> > reference2IntEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Reference2IntMap.Entry <K>)new AbstractReference2IntMap.BasicEntry <K>(key, value), (Comparator<? super Reference2IntMap.Entry <K> >)entryComparator(comparator)); return (ObjectSortedSet<Reference2IntMap.Entry <K> >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
