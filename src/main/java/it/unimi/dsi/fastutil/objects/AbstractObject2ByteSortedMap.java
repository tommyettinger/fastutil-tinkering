...
public abstract class AbstractObject2ByteSortedMap <K> extends AbstractObject2ByteMap <K> implements Object2ByteSortedMap <K> {
	...
	protected class KeySet extends AbstractObjectSortedSet <K> {
	 ...
	 @Override
	 public ObjectBidirectionalIterator <K> iterator(final K from) { return new KeySetIterator <K>(object2ByteEntrySet().iterator(new BasicEntry <K>(from, ((byte)0)))); }
	 @Override
	 public ObjectBidirectionalIterator <K> iterator() { return new KeySetIterator <K>(object2ByteEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractByteCollection {
	 @Override
	 public ByteIterator iterator() { return new ValuesIterator <K>(object2ByteEntrySet().iterator()); }
	 @Override
