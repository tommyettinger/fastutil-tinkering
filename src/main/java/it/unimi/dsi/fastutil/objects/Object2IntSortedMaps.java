...
public class Object2IntSortedMaps {
	...
	public static class Singleton <K> extends Object2IntMaps.Singleton <K> implements Object2IntSortedMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSortedSet<Object2IntMap.Entry <K> > object2IntEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Object2IntMap.Entry <K>)new AbstractObject2IntMap.BasicEntry <K>(key, value), (Comparator<? super Object2IntMap.Entry <K> >)entryComparator(comparator)); return (ObjectSortedSet<Object2IntMap.Entry <K> >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
