...
public class ObjectLists {
	...
	public static class SynchronizedList <K> extends ObjectCollections.SynchronizedCollection <K> implements ObjectList <K>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectList <K> subList(final int from, final int to) { synchronized(sync) { return new SynchronizedList <K>(list.subList(from, to), sync); } }
	 /* {@inheritDoc}
		 * @deprecated As of <code>fastutil</code> 5, replaced by {@link #subList(int,int)}.
		 */
	 @Deprecated
	...
	public static class SynchronizedRandomAccessList <K> extends SynchronizedList <K> implements RandomAccess, java.io.Serializable {
	 ...
	 @Override
	 public ObjectList <K> subList(final int from, final int to) { synchronized(sync) { return new SynchronizedRandomAccessList <K>(list.subList(from, to), sync); } }
	}
	...
	public static class UnmodifiableList <K> extends ObjectCollections.UnmodifiableCollection <K> implements ObjectList <K>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectListIterator <K> objectListIterator(final int i) { return listIterator(i); }
	 public ObjectList <K> subList(final int from, final int to) { return new UnmodifiableList <K>(list.subList(from, to)); }
	 /* {@inheritDoc}
		 * @deprecated As of <code>fastutil</code> 5, replaced by {@link #subList(int,int)}.
		 */
	 @Deprecated
	...
	public static class UnmodifiableRandomAccessList <K> extends UnmodifiableList <K> implements RandomAccess, java.io.Serializable {
	 ...
	 @Override
	 public ObjectList <K> subList(final int from, final int to) { return new UnmodifiableRandomAccessList <K>(list.subList(from, to)); }
	}
