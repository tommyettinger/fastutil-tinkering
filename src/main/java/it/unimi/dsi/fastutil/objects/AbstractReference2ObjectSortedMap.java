...
public abstract class AbstractReference2ObjectSortedMap <K,V> extends AbstractReference2ObjectMap <K,V> implements Reference2ObjectSortedMap <K,V> {
	...
	protected class KeySet extends AbstractReferenceSortedSet <K> {
	 ...
	 @Override
	 public ObjectBidirectionalIterator <K> iterator(final K from) { return new KeySetIterator <K,V>(reference2ObjectEntrySet().iterator(new BasicEntry <K,V>(from, (null)))); }
	 @Override
	 public ObjectBidirectionalIterator <K> iterator() { return new KeySetIterator <K,V>(reference2ObjectEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractObjectCollection <V> {
	 @Override
	 public ObjectIterator <V> iterator() { return new ValuesIterator <K,V>(reference2ObjectEntrySet().iterator()); }
	 @Override
