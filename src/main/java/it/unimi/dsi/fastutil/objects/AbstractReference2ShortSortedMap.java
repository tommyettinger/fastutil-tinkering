...
public abstract class AbstractReference2ShortSortedMap <K> extends AbstractReference2ShortMap <K> implements Reference2ShortSortedMap <K> {
	...
	protected class KeySet extends AbstractReferenceSortedSet <K> {
	 ...
	 @Override
	 public ObjectBidirectionalIterator <K> iterator(final K from) { return new KeySetIterator <K>(reference2ShortEntrySet().iterator(new BasicEntry <K>(from, ((short)0)))); }
	 @Override
	 public ObjectBidirectionalIterator <K> iterator() { return new KeySetIterator <K>(reference2ShortEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractShortCollection {
	 @Override
	 public ShortIterator iterator() { return new ValuesIterator <K>(reference2ShortEntrySet().iterator()); }
	 @Override
