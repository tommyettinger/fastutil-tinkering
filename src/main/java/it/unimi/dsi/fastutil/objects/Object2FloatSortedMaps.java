...
public class Object2FloatSortedMaps {
	...
	public static class Singleton <K> extends Object2FloatMaps.Singleton <K> implements Object2FloatSortedMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSortedSet<Object2FloatMap.Entry <K> > object2FloatEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Object2FloatMap.Entry <K>)new AbstractObject2FloatMap.BasicEntry <K>(key, value), (Comparator<? super Object2FloatMap.Entry <K> >)entryComparator(comparator)); return (ObjectSortedSet<Object2FloatMap.Entry <K> >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
