...
public abstract class AbstractObject2CharSortedMap <K> extends AbstractObject2CharMap <K> implements Object2CharSortedMap <K> {
	...
	protected class KeySet extends AbstractObjectSortedSet <K> {
	 ...
	 @Override
	 public ObjectBidirectionalIterator <K> iterator(final K from) { return new KeySetIterator <K>(object2CharEntrySet().iterator(new BasicEntry <K>(from, ((char)0)))); }
	 @Override
	 public ObjectBidirectionalIterator <K> iterator() { return new KeySetIterator <K>(object2CharEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractCharCollection {
	 @Override
	 public CharIterator iterator() { return new ValuesIterator <K>(object2CharEntrySet().iterator()); }
	 @Override
