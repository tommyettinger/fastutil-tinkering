...
public abstract class AbstractObject2BooleanSortedMap <K> extends AbstractObject2BooleanMap <K> implements Object2BooleanSortedMap <K> {
	...
	protected class KeySet extends AbstractObjectSortedSet <K> {
	 ...
	 @Override
	 public ObjectBidirectionalIterator <K> iterator(final K from) { return new KeySetIterator <K>(object2BooleanEntrySet().iterator(new BasicEntry <K>(from, (false)))); }
	 @Override
	 public ObjectBidirectionalIterator <K> iterator() { return new KeySetIterator <K>(object2BooleanEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractBooleanCollection {
	 @Override
	 public BooleanIterator iterator() { return new ValuesIterator <K>(object2BooleanEntrySet().iterator()); }
	 @Override
