...
public class Object2ObjectSortedMaps {
	...
	public static class Singleton <K,V> extends Object2ObjectMaps.Singleton <K,V> implements Object2ObjectSortedMap <K,V>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSortedSet<Object2ObjectMap.Entry <K,V> > object2ObjectEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Object2ObjectMap.Entry <K,V>)new AbstractObject2ObjectMap.BasicEntry <K,V>(key, value), (Comparator<? super Object2ObjectMap.Entry <K,V> >)entryComparator(comparator)); return (ObjectSortedSet<Object2ObjectMap.Entry <K,V> >)entries; }
	 /** {@inheritDoc} */
	 @Override
