...
public class Reference2LongSortedMaps {
	...
	public static class Singleton <K> extends Reference2LongMaps.Singleton <K> implements Reference2LongSortedMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSortedSet<Reference2LongMap.Entry <K> > reference2LongEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Reference2LongMap.Entry <K>)new AbstractReference2LongMap.BasicEntry <K>(key, value), (Comparator<? super Reference2LongMap.Entry <K> >)entryComparator(comparator)); return (ObjectSortedSet<Reference2LongMap.Entry <K> >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
