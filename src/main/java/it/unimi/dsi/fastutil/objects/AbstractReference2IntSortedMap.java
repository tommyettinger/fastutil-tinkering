...
public abstract class AbstractReference2IntSortedMap <K> extends AbstractReference2IntMap <K> implements Reference2IntSortedMap <K> {
	...
	protected class KeySet extends AbstractReferenceSortedSet <K> {
	 ...
	 @Override
	 public ObjectBidirectionalIterator <K> iterator(final K from) { return new KeySetIterator <K>(reference2IntEntrySet().iterator(new BasicEntry <K>(from, (0)))); }
	 @Override
	 public ObjectBidirectionalIterator <K> iterator() { return new KeySetIterator <K>(reference2IntEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractIntCollection {
	 @Override
	 public IntIterator iterator() { return new ValuesIterator <K>(reference2IntEntrySet().iterator()); }
	 @Override
