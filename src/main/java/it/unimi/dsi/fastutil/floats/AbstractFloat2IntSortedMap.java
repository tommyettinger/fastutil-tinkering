...
public abstract class AbstractFloat2IntSortedMap extends AbstractFloat2IntMap implements Float2IntSortedMap {
	...
	protected class KeySet extends AbstractFloatSortedSet {
	 ...
	 @Override
	 public FloatBidirectionalIterator iterator() { return new KeySetIterator (float2IntEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractIntCollection {
	 @Override
	 public IntIterator iterator() { return new ValuesIterator (float2IntEntrySet().iterator()); }
	 @Override
