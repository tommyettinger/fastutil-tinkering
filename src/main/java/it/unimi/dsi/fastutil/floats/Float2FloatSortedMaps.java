...
public class Float2FloatSortedMaps {
	...
	public static class Singleton extends Float2FloatMaps.Singleton implements Float2FloatSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Float2FloatMap.Entry > float2FloatEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Float2FloatMap.Entry )new AbstractFloat2FloatMap.BasicEntry (key, value), (Comparator<? super Float2FloatMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Float2FloatMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
