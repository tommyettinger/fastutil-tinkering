...
public class Float2IntSortedMaps {
	...
	public static class Singleton extends Float2IntMaps.Singleton implements Float2IntSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Float2IntMap.Entry > float2IntEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Float2IntMap.Entry )new AbstractFloat2IntMap.BasicEntry (key, value), (Comparator<? super Float2IntMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Float2IntMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
