...
public abstract class AbstractFloat2ObjectSortedMap <V> extends AbstractFloat2ObjectMap <V> implements Float2ObjectSortedMap <V> {
	...
	protected class KeySet extends AbstractFloatSortedSet {
	 ...
	 @Override
	 public FloatBidirectionalIterator iterator(final float from) { return new KeySetIterator <V>(float2ObjectEntrySet().iterator(new BasicEntry <V>(from, (null)))); }
	 @Override
	 public FloatBidirectionalIterator iterator() { return new KeySetIterator <V>(float2ObjectEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractObjectCollection <V> {
	 @Override
	 public ObjectIterator <V> iterator() { return new ValuesIterator <V>(float2ObjectEntrySet().iterator()); }
	 @Override
