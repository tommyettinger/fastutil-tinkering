...
public abstract class AbstractFloat2ShortSortedMap extends AbstractFloat2ShortMap implements Float2ShortSortedMap {
	...
	protected class KeySet extends AbstractFloatSortedSet {
	 ...
	 @Override
	 public FloatBidirectionalIterator iterator() { return new KeySetIterator (float2ShortEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractShortCollection {
	 @Override
	 public ShortIterator iterator() { return new ValuesIterator (float2ShortEntrySet().iterator()); }
	 @Override
