...
public class Float2ObjectSortedMaps {
	...
	public static class Singleton <V> extends Float2ObjectMaps.Singleton <V> implements Float2ObjectSortedMap <V>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Float2ObjectMap.Entry <V> > float2ObjectEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Float2ObjectMap.Entry <V>)new AbstractFloat2ObjectMap.BasicEntry <V>(key, value), (Comparator<? super Float2ObjectMap.Entry <V> >)entryComparator(comparator)); return (ObjectSortedSet<Float2ObjectMap.Entry <V> >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
