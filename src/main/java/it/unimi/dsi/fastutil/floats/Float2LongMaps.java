...
public class Float2LongMaps {
	...
	public static class Singleton extends Float2LongFunctions.Singleton implements Float2LongMap , java.io.Serializable, Cloneable {
	 ...
	 public void putAll(final Map<? extends Float, ? extends Long> m) { throw new UnsupportedOperationException(); }
	 @Override
	 public ObjectSet<Float2LongMap.Entry > float2LongEntrySet() { if (entries == null) entries = ObjectSets.singleton((Float2LongMap.Entry )new AbstractFloat2LongMap.BasicEntry (key, value)); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	...
	public static class SynchronizedMap extends Float2LongFunctions.SynchronizedFunction implements Float2LongMap , java.io.Serializable {
	 ...
	 public ObjectSet<Float2LongMap.Entry > float2LongEntrySet() {
	  synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.float2LongEntrySet(), sync); return entries; }
	 }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
