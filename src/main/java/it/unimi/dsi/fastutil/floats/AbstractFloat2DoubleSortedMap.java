...
public abstract class AbstractFloat2DoubleSortedMap extends AbstractFloat2DoubleMap implements Float2DoubleSortedMap {
	...
	protected class KeySet extends AbstractFloatSortedSet {
	 ...
	 @Override
	 public FloatBidirectionalIterator iterator() { return new KeySetIterator (float2DoubleEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractDoubleCollection {
	 @Override
	 public DoubleIterator iterator() { return new ValuesIterator (float2DoubleEntrySet().iterator()); }
	 @Override
