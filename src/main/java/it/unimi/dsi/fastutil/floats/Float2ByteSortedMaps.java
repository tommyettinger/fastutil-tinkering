...
public class Float2ByteSortedMaps {
	...
	public static class Singleton extends Float2ByteMaps.Singleton implements Float2ByteSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Float2ByteMap.Entry > float2ByteEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Float2ByteMap.Entry )new AbstractFloat2ByteMap.BasicEntry (key, value), (Comparator<? super Float2ByteMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Float2ByteMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
