...
public abstract class AbstractFloat2LongSortedMap extends AbstractFloat2LongMap implements Float2LongSortedMap {
	...
	protected class KeySet extends AbstractFloatSortedSet {
	 ...
	 @Override
	 public FloatBidirectionalIterator iterator() { return new KeySetIterator (float2LongEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractLongCollection {
	 @Override
	 public LongIterator iterator() { return new ValuesIterator (float2LongEntrySet().iterator()); }
	 @Override
