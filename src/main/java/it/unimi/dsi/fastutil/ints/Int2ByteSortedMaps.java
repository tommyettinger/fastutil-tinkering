...
public class Int2ByteSortedMaps {
	...
	public static class Singleton extends Int2ByteMaps.Singleton implements Int2ByteSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Int2ByteMap.Entry > int2ByteEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Int2ByteMap.Entry )new AbstractInt2ByteMap.BasicEntry (key, value), (Comparator<? super Int2ByteMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Int2ByteMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
