...
public class Int2DoubleMaps {
	...
	public static class Singleton extends Int2DoubleFunctions.Singleton implements Int2DoubleMap , java.io.Serializable, Cloneable {
	 ...
	 public void putAll(final Map<? extends Integer, ? extends Double> m) { throw new UnsupportedOperationException(); }
	 @Override
	 public ObjectSet<Int2DoubleMap.Entry > int2DoubleEntrySet() { if (entries == null) entries = ObjectSets.singleton((Int2DoubleMap.Entry )new AbstractInt2DoubleMap.BasicEntry (key, value)); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	...
	public static class SynchronizedMap extends Int2DoubleFunctions.SynchronizedFunction implements Int2DoubleMap , java.io.Serializable {
	 ...
	 public ObjectSet<Int2DoubleMap.Entry > int2DoubleEntrySet() {
	  synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.int2DoubleEntrySet(), sync); return entries; }
	 }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
