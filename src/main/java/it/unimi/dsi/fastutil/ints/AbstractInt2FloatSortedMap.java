...
public abstract class AbstractInt2FloatSortedMap extends AbstractInt2FloatMap implements Int2FloatSortedMap {
	...
	protected class KeySet extends AbstractIntSortedSet {
	 ...
	 @Override
	 public IntBidirectionalIterator iterator() { return new KeySetIterator (int2FloatEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractFloatCollection {
	 @Override
	 public FloatIterator iterator() { return new ValuesIterator (int2FloatEntrySet().iterator()); }
	 @Override
