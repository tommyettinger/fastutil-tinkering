...
public class Int2ReferenceSortedMaps {
	...
	public static class Singleton <V> extends Int2ReferenceMaps.Singleton <V> implements Int2ReferenceSortedMap <V>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Int2ReferenceMap.Entry <V> > int2ReferenceEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Int2ReferenceMap.Entry <V>)new AbstractInt2ReferenceMap.BasicEntry <V>(key, value), (Comparator<? super Int2ReferenceMap.Entry <V> >)entryComparator(comparator)); return (ObjectSortedSet<Int2ReferenceMap.Entry <V> >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
