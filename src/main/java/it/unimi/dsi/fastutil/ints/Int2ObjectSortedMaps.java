...
public class Int2ObjectSortedMaps {
	...
	public static class Singleton <V> extends Int2ObjectMaps.Singleton <V> implements Int2ObjectSortedMap <V>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Int2ObjectMap.Entry <V> > int2ObjectEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Int2ObjectMap.Entry <V>)new AbstractInt2ObjectMap.BasicEntry <V>(key, value), (Comparator<? super Int2ObjectMap.Entry <V> >)entryComparator(comparator)); return (ObjectSortedSet<Int2ObjectMap.Entry <V> >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
