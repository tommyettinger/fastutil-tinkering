...
public class Int2LongSortedMaps {
	...
	public static class Singleton extends Int2LongMaps.Singleton implements Int2LongSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Int2LongMap.Entry > int2LongEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Int2LongMap.Entry )new AbstractInt2LongMap.BasicEntry (key, value), (Comparator<? super Int2LongMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Int2LongMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
