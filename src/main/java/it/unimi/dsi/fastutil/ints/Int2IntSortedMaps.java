...
public class Int2IntSortedMaps {
	...
	public static class Singleton extends Int2IntMaps.Singleton implements Int2IntSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Int2IntMap.Entry > int2IntEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Int2IntMap.Entry )new AbstractInt2IntMap.BasicEntry (key, value), (Comparator<? super Int2IntMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Int2IntMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
