...
public abstract class AbstractInt2BooleanSortedMap extends AbstractInt2BooleanMap implements Int2BooleanSortedMap {
	...
	protected class KeySet extends AbstractIntSortedSet {
	 ...
	 @Override
	 public IntBidirectionalIterator iterator() { return new KeySetIterator (int2BooleanEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractBooleanCollection {
	 @Override
	 public BooleanIterator iterator() { return new ValuesIterator (int2BooleanEntrySet().iterator()); }
	 @Override
