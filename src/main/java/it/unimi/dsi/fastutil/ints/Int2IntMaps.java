...
public class Int2IntMaps {
	...
	public static class Singleton extends Int2IntFunctions.Singleton implements Int2IntMap , java.io.Serializable, Cloneable {
	 ...
	 public void putAll(final Map<? extends Integer, ? extends Integer> m) { throw new UnsupportedOperationException(); }
	 @Override
	 public ObjectSet<Int2IntMap.Entry > int2IntEntrySet() { if (entries == null) entries = ObjectSets.singleton((Int2IntMap.Entry )new AbstractInt2IntMap.BasicEntry (key, value)); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	...
	public static class SynchronizedMap extends Int2IntFunctions.SynchronizedFunction implements Int2IntMap , java.io.Serializable {
	 ...
	 public ObjectSet<Int2IntMap.Entry > int2IntEntrySet() {
	  synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.int2IntEntrySet(), sync); return entries; }
	 }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
