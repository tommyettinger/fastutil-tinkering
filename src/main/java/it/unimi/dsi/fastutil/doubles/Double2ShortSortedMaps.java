...
public class Double2ShortSortedMaps {
	...
	public static class Singleton extends Double2ShortMaps.Singleton implements Double2ShortSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Double2ShortMap.Entry > double2ShortEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Double2ShortMap.Entry )new AbstractDouble2ShortMap.BasicEntry (key, value), (Comparator<? super Double2ShortMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Double2ShortMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
