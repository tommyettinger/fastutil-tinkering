...
public abstract class AbstractDouble2DoubleSortedMap extends AbstractDouble2DoubleMap implements Double2DoubleSortedMap {
	...
	protected class KeySet extends AbstractDoubleSortedSet {
	 ...
	 @Override
	 public DoubleBidirectionalIterator iterator() { return new KeySetIterator (double2DoubleEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractDoubleCollection {
	 @Override
	 public DoubleIterator iterator() { return new ValuesIterator (double2DoubleEntrySet().iterator()); }
	 @Override
