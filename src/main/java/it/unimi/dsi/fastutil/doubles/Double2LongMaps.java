...
public class Double2LongMaps {
	...
	public static class Singleton extends Double2LongFunctions.Singleton implements Double2LongMap , java.io.Serializable, Cloneable {
	 ...
	 public void putAll(final Map<? extends Double, ? extends Long> m) { throw new UnsupportedOperationException(); }
	 @Override
	 public ObjectSet<Double2LongMap.Entry > double2LongEntrySet() { if (entries == null) entries = ObjectSets.singleton((Double2LongMap.Entry )new AbstractDouble2LongMap.BasicEntry (key, value)); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	...
	public static class SynchronizedMap extends Double2LongFunctions.SynchronizedFunction implements Double2LongMap , java.io.Serializable {
	 ...
	 public ObjectSet<Double2LongMap.Entry > double2LongEntrySet() {
	  synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.double2LongEntrySet(), sync); return entries; }
	 }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
