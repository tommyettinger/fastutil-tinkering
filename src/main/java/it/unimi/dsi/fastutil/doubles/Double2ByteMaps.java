...
public class Double2ByteMaps {
	...
	public static class Singleton extends Double2ByteFunctions.Singleton implements Double2ByteMap , java.io.Serializable, Cloneable {
	 ...
	 public void putAll(final Map<? extends Double, ? extends Byte> m) { throw new UnsupportedOperationException(); }
	 @Override
	 public ObjectSet<Double2ByteMap.Entry > double2ByteEntrySet() { if (entries == null) entries = ObjectSets.singleton((Double2ByteMap.Entry )new AbstractDouble2ByteMap.BasicEntry (key, value)); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	...
	public static class SynchronizedMap extends Double2ByteFunctions.SynchronizedFunction implements Double2ByteMap , java.io.Serializable {
	 ...
	 public ObjectSet<Double2ByteMap.Entry > double2ByteEntrySet() {
	  synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.double2ByteEntrySet(), sync); return entries; }
	 }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
