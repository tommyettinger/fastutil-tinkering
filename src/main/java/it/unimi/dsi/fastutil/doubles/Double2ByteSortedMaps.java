...
public class Double2ByteSortedMaps {
	...
	public static class Singleton extends Double2ByteMaps.Singleton implements Double2ByteSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Double2ByteMap.Entry > double2ByteEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Double2ByteMap.Entry )new AbstractDouble2ByteMap.BasicEntry (key, value), (Comparator<? super Double2ByteMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Double2ByteMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
