...
public class Double2IntSortedMaps {
	...
	public static class Singleton extends Double2IntMaps.Singleton implements Double2IntSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Double2IntMap.Entry > double2IntEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Double2IntMap.Entry )new AbstractDouble2IntMap.BasicEntry (key, value), (Comparator<? super Double2IntMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Double2IntMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
