...
public class DoubleComparators {
	...
	protected static class NaturalImplicitComparator extends AbstractDoubleComparator implements java.io.Serializable {
	...
	protected static class OppositeImplicitComparator extends AbstractDoubleComparator implements java.io.Serializable {
	 private static final long serialVersionUID = 1L;
	 @Override
	 public final int compare(final double a, final double b) {
	  return - ( Double.compare((a),(b)) );
	...
	protected static class OppositeComparator extends AbstractDoubleComparator implements java.io.Serializable {
	 private static final long serialVersionUID = 1L;
