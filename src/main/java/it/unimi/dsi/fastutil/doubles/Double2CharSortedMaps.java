...
public class Double2CharSortedMaps {
	...
	public static class Singleton extends Double2CharMaps.Singleton implements Double2CharSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Double2CharMap.Entry > double2CharEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Double2CharMap.Entry )new AbstractDouble2CharMap.BasicEntry (key, value), (Comparator<? super Double2CharMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Double2CharMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
