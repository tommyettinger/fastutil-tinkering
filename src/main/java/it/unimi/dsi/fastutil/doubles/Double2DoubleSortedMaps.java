...
public class Double2DoubleSortedMaps {
	...
	public static class Singleton extends Double2DoubleMaps.Singleton implements Double2DoubleSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Double2DoubleMap.Entry > double2DoubleEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Double2DoubleMap.Entry )new AbstractDouble2DoubleMap.BasicEntry (key, value), (Comparator<? super Double2DoubleMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Double2DoubleMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
