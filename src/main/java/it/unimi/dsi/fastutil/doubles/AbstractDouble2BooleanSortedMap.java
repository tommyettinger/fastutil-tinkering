...
public abstract class AbstractDouble2BooleanSortedMap extends AbstractDouble2BooleanMap implements Double2BooleanSortedMap {
	...
	protected class KeySet extends AbstractDoubleSortedSet {
	 ...
	 @Override
	 public DoubleBidirectionalIterator iterator() { return new KeySetIterator (double2BooleanEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractBooleanCollection {
	 @Override
	 public BooleanIterator iterator() { return new ValuesIterator (double2BooleanEntrySet().iterator()); }
	 @Override
