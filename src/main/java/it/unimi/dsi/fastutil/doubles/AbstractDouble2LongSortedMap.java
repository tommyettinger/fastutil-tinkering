...
public abstract class AbstractDouble2LongSortedMap extends AbstractDouble2LongMap implements Double2LongSortedMap {
	...
	protected class KeySet extends AbstractDoubleSortedSet {
	 ...
	 @Override
	 public DoubleBidirectionalIterator iterator() { return new KeySetIterator (double2LongEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractLongCollection {
	 @Override
	 public LongIterator iterator() { return new ValuesIterator (double2LongEntrySet().iterator()); }
	 @Override
