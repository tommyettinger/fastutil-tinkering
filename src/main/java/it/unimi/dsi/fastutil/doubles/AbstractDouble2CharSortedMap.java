...
public abstract class AbstractDouble2CharSortedMap extends AbstractDouble2CharMap implements Double2CharSortedMap {
	...
	protected class KeySet extends AbstractDoubleSortedSet {
	 ...
	 @Override
	 public DoubleBidirectionalIterator iterator() { return new KeySetIterator (double2CharEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractCharCollection {
	 @Override
	 public CharIterator iterator() { return new ValuesIterator (double2CharEntrySet().iterator()); }
	 @Override
