...
public abstract class AbstractDouble2ReferenceSortedMap <V> extends AbstractDouble2ReferenceMap <V> implements Double2ReferenceSortedMap <V> {
	...
	protected class KeySet extends AbstractDoubleSortedSet {
	 ...
	 @Override
	 public DoubleBidirectionalIterator iterator(final double from) { return new KeySetIterator <V>(double2ReferenceEntrySet().iterator(new BasicEntry <V>(from, (null)))); }
	 @Override
	 public DoubleBidirectionalIterator iterator() { return new KeySetIterator <V>(double2ReferenceEntrySet().iterator()); }
	}
	...
	protected class ValuesCollection extends AbstractReferenceCollection <V> {
	 @Override
	 public ObjectIterator <V> iterator() { return new ValuesIterator <V>(double2ReferenceEntrySet().iterator()); }
	 @Override
