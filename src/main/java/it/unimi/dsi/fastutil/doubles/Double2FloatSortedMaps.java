...
public class Double2FloatSortedMaps {
	...
	public static class Singleton extends Double2FloatMaps.Singleton implements Double2FloatSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Double2FloatMap.Entry > double2FloatEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Double2FloatMap.Entry )new AbstractDouble2FloatMap.BasicEntry (key, value), (Comparator<? super Double2FloatMap.Entry >)entryComparator(comparator)); return (ObjectSortedSet<Double2FloatMap.Entry >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
