...
public class Double2ObjectSortedMaps {
	...
	public static class Singleton <V> extends Double2ObjectMaps.Singleton <V> implements Double2ObjectSortedMap <V>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Double2ObjectMap.Entry <V> > double2ObjectEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton((Double2ObjectMap.Entry <V>)new AbstractDouble2ObjectMap.BasicEntry <V>(key, value), (Comparator<? super Double2ObjectMap.Entry <V> >)entryComparator(comparator)); return (ObjectSortedSet<Double2ObjectMap.Entry <V> >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
